			...
			<div class="row">
				<div class="col-md-3">
					...
					<ul class="contact-info">
						<li><i class="icon-map"></i>Jalan Kh. Muchtar Tabrani No.96, Bekasi-Indonesia</li>
						<li><i class="icon-phone"></i>+62 812 1221 0992</li>
						<li><i class="icon-envelope"></i><a href="#">servprojectsociety@gmail.com</a></li>
						<li><i class="icon-globe"></i><a href="#">www.project-society.com</a></li>
					</ul>
				</div>
